  ...
  return (
    <section className="py-20 sm:py-32 bg-[#eef8f5] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-lg p-6 sm:p-8 lg:p-12 max-w-5xl mx-auto">
          <div className="flex flex-col items-center mb-8 sm:mb-12">
            {/* CEO写真 */}
            <div className="relative group mb-6">
              <div className="absolute inset-0 bg-[#00897B]/15 rounded-lg blur-lg" />
              <img 
                src={ceoImage} 
                alt="代表取締役CEO 一二三 晴也" 
                className="relative w-32 h-32 sm:w-48 sm:h-48 object-cover rounded-lg"
              />
            </div>
