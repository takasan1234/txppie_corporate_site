    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#f8fffe] to-white">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 py-32">
        <div className="text-center">
          ...
          >
            Transforming<br className="sm:hidden" /> patient voices into
          ...
          >
            We tackle the social challenge of <span className="text-[#00897B]">insufficient medical information</span>
            <br className="hidden sm:block" />
            by providing a <span className="text-[#00897B]">patient-driven</span> DX platform for collecting and analyzing medical data.
          </motion.p>
