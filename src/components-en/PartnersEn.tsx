...
export function PartnersEn() {
  const programs = [
    {
      name: "Innovators' Club Osaka Univ.",
      description: "Support in areas such as management and legal affairs provided by specialists from Osaka University",
      image: innovatorsClubImage,
    },
    {
      name: "Booming!",
      description: "An accelerator program aimed at achieving an IPO within five years",
      image: boomingImage,
    },
    {
      name: "Soil",
      description: "A grant program that supports businesses with social significance",
      image: soilImage,
    },
  ];
    ...
    <section className="py-20 sm:py-32 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="mb-12 sm:mb-16">
          ...
          <h2 className="text-gray-900 mb-4 sm:mb-6">Partner Organizations & Selected Programs</h2>
